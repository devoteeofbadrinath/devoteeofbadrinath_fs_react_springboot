...
function App() {
  ...
  <div className='flex justify-center items-center gap-4 bg-gray-300 mt-4 p-4 flex-col'>
    ...
    <button 
    className='px-6 py-2 m-4 bg-red-400 text-white rounded-lg hover:bg-red-700 
  ...
  <div className='bg-shivam-500 h-[165px] w-[300px] border border-green-600 p-4 rounded-lg m-4 flex items-center justify-center'>
    Theme variables
  </div>
